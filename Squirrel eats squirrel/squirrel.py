...
# 1. Zgolemuvanje na prozorot na igrata
...
# 2. Dve novi promenlivi za koordinatite
CAMERASLACK_X = 120
CAMERASLACK_Y = 120
...
# 4. Nova konstanta za golemina za koja igrata se smeta za izgubena
LOSTSIZE = 10

# 5. Nova promenliva vo koja kje bidat smesteni osvoenite poeni na igrachot
playerScore = 0
...
def runGame():
    ...
    while True:  # main game loop
        ...
        for sObj in squirrelObjs:
            ...
            # 3. spored sluchajno izbrana vrednost, smeni go pavecot na dvizhenje
            sObj["y"] += sObj["movey"] * sObj["bounce_direction"]
            sObj["bounce"] += 1
        ...
        # 2. Promena na referencite so dvete novi promenlivi
            ...
            for i in range(len(squirrelObjs) - 1, -1, -1):
                ...
                if "rect" in sqObj and playerObj["rect"].colliderect(sqObj["rect"]):
                    ...
                    if sqObj["width"] * sqObj["height"] <= playerObj["size"] ** 2:
                        ...
                        # 5. Zgolemuvanje na poenite na igrachot
                        playerScore += 1
                        ...
                        # 4. Koga kje dopre pogolema ververichka, ververichkata na igrachot se namaluva
                        playerObj["size"] -= (
                                int((playerObj["size"] * playerObj["size"]) ** 0.2) + 1
                        )

                        # 4. Nov uslov za zavrshuvanje na igrata
        ...
        # 5. Prikaz na osvoeni poeni na igrachot
        scoreSurf = BASICFONT.render(f"Score: {playerScore}", True, RED)
...
def makeNewSquirrel(camerax, cameray):
    ...
    # 3. Nova informacija za random izbran pravec
    sq["bounce_direction"] = random.choice([-1, 1])
